...
static emlrtRTEInfo emlrtRTEI = {
    ...
    "\\\xe6\x94\xb9\xe8\x89\xafModule_lib\\0318"
    "\\calc_pos_0318.m" /* pName */
};
...
void calc_pos_0318(const emlrtStack *sp, const struct0_T *LP, struct1_T *SV)
{
  ...
  for (b_i = 0; b_i < i; b_i++) {
    ...
    if (LP->BB[b_i] == 0.0) {
      ...
      if (LP->BB[b_i] != 0.0) {
        ...
        if (LP->J_type[b_LP - 1] == 'R') {
          ...
          for (i1 = 0; i1 < 3; i1++) {
            ...
            b = ((b_Cz_tmp < 1.0) || (b_Cz_tmp > 27.0));
            if (b) {
              emlrtDynamicBoundsCheckR2012b((int32_T)b_Cz_tmp, 1, 27,
            ...
            if (b) {
              emlrtDynamicBoundsCheckR2012b(b_A_I_BB_tmp, 1, 27, &o_emlrtBCI,
                                            (emlrtConstCTX)sp);
            }
      ...
      if (guard1 && (LP->BB[b_i] != 0.0)) {
        ...
        b_LP = (int32_T)LP->BB[b_i];
        if ((b_LP < 1) || (b_LP > 9)) {
          emlrtDynamicBoundsCheckR2012b(b_LP, 1, 9, &n_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
