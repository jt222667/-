...
options = optimoptions('ga', ...
    ...
    'PopulationSize', 10, ...        % 种群大小 (越大搜索越广，但越慢)
    'MaxGenerations', 3, ...       % 最大进化代数
    'PlotFcn', @gaplotbestf, ...
    'OutputFcn', @ga_outfun);   % 👈 加这个
